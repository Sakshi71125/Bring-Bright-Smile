...
<body>
    ...
    <nav class="navbar navbar-expand-lg my-navbar">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a href="./vol.php" class="nav-link active">Volunteer</a>
          </li>
          <li class="nav-item">
  ...
  <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner">
      <div class="carousel-item active cover-img">
        <img src="./images/gal-2.png" alt="" srcset="" width="100%" height="100%">
      </div>
    </div>
  </div>
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="section-title" data-aos="fade-right">
            <h2>Opportunities at "We For You"</h2>
          </div>
        </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-12 col-md-6">
          <div class="section-title-new" style="text-align: center;" data-aos="fade-right">
            <h2>Fields</h2>
          </div>
        </div>
        <div class="col-lg-12">
          ...
          <div style="text-align: center;">
            <a href="internship.php"><button class="btn btn-primary">Apply Here</button></a>
          </div>
        </div>
      </div>
